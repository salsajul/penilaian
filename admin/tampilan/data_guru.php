    ...
    <div class="container">
        ...
        <div class="side-kanan">
            ...
            <div class="halaman-data">
                <div class="tambah">
                <a href="../input/input_guru.php"><button>Tambah Data Guru</button></a>
                </div>
                <table class="tabel1">
                    <tr>
                    <th>No</th>
                    ...
                    ?>
                        ...
                        <td><?php echo $row['tmp_lahir_guru']; ?></td>
                        <td><?php echo $row['tgl_lahir_guru']; ?></td>
                        <td><?php echo $row['jkel_guru']; ?></td>
                        <td>
                            <div class="aksi_edit">
                            <a href='../input/edit_guru.php?nip=<?php echo $row['nip']; ?>'><button>Edit</button></a>
                            </div>
                        </td>
                        <td>
                            <div class="aksi_detail">
                            <a href='detail_guru.php?nip=<?php echo $row['nip']; ?>'><button>Detail</button></a>
                            </div>
                        </td>
                        <td>
                        <div class="aksi_hapus">
                        <a href='delete_guru.php?nip=<?php echo $row['nip']; ?>' onclick="return confirm('Apakah anda yakin hapus data ini?')"><button>Hapus</button></a>
                            </div>
                        </td>
                    </tr>
                    <?php 
