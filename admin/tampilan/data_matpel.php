    ...
    <div class="container">
        ...
        <div class="side-kanan">
            ...
            <div class="halaman-data">
                <div class="tambah">
                <a href="../input/input_matpel.php"><button>Tambah Data Mata Pelajaran</button></a>
                </div>
                <table class="tabel1">
                    <tr>
                    <th>No</th>
                    ...
                    ?>
                        ...
                        <td>
                            <div class="aksi_edit">
                            <a href='../input/edit_matpel.php?kd_matpel=<?php echo $row['kd_matpel']; ?>'><button>Edit</button></a>
                            </div>
                        </td>
                        <td>
                        <div class="aksi_hapus">
                        <a href='delete_matpel.php?kd_matpel=<?php echo $row['kd_matpel']; ?>' onclick="return confirm('Apakah anda yakin hapus data ini?')"><button>Hapus</button></a>
                            </div>
                        </td>
                    </tr>
                    <?php 
