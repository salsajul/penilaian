    ...
    <div class="container">
        ...
        <div class="side-kanan">
            ...
            <div class="halaman-data">
                <div class="tambah">
                <a href="../input/input_siswa.php"><button>Tambah Data Siswa</button></a>
                </div>
                <table class="tabel1">
                    <tr>
                    <th>No</th>
                    ...
                    ?>
                        ...
                        <td>
                            <div class="aksi_edit">
                            <a href='../input/edit_siswa.php?nis=<?php echo $row['nis']; ?>'><button>Edit</button></a>
                            </div>
                        </td>
                        <td>
                            <div class="aksi_detail">
                            <a href='detail_siswa.php?nis=<?php echo $row['nis']; ?>'><button>Detail</button></a>
                            </div>
                        </td>
                        <td>
                        <div class="aksi_hapus">
                        <a href='delete_siswa.php?nis=<?php echo $row['nis']; ?>' onclick="return confirm('Apakah anda yakin hapus data ini?')"><button>Hapus</button></a>
                            </div>
                        </td>
                    </tr>
                    <?php 
